...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener
{
    ...
    String[] SongTitles = {"Heroes", "Once in a Lifetime", "Wish You Were Here"};
    int[] SongIDs;
    int CurSong;
    MediaPlayer MP;
    Boolean Act;
    ...
    public void onCreate ()
    {
        ...
        SongIDs = new int[3];
        SongIDs[0] = R.raw.heroes;
        SongIDs[1] = R.raw.once_in_a_lifetime;
        SongIDs[2] = R.raw.wish_you_were_here;
        CurSong = 0;
